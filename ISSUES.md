...
- [ ] **Remove Editor remaining static methods**. Due to design decision we moved to instance base approach for the Editor, which was the best suiting architecture. However there may be some code pieces related to previous static architecter, which should be removed with related references and tests.
